...
import { useConnectionRelations, type ConnectionRelationMeta } from "@/features/vocabularies/use-vocabularies";
...
export function ConnectionRelationsPanel() {
    ...
    const updateMutation = useMutation({
        mutationFn: async ({ id, body }: { id: string; body: Partial<RelationCreateBody> }) =>
            unwrapEden(await api.api["connection-relations"]({ id }).patch(body)),
        onSuccess: () => {
            qc.invalidateQueries({ queryKey: ["connection-relations"] });
