    ...
    return (
        <div className="flex items-center gap-1.5">
            ...
            <div className="relative flex h-4 w-4 shrink-0 items-center justify-center">
                <div className="absolute inset-0 rounded-full opacity-20" style={{ background: accent }} />
                <div className="h-2 w-2 rounded-full" style={{ background: healthColor(healthScore) }} />
            </div>
            <span className="max-w-[90px] truncate text-[9px] leading-tight" style={{ color: accent }}>
                {title}
            </span>
        </div>
    );
