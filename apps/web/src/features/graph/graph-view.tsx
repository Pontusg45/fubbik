...
const ISLAND_PALETTE = ["#3b82f6", "#22c55e", "#f59e0b", "#ef4444", "#a855f7", "#06b6d4", "#ec4899", "#84cc16", "#f97316", "#6366f1"];
...
function GraphViewInner() {
    ...
    const { zoom, zoomToIsland, goBack, goToOverview, setFocusChunk } = useGraphZoom(
    ...
    return (
        <div className="flex h-[calc(100vh-4rem)] max-md:flex-col">
                                ...
                                <span key={i} className="flex items-center gap-1">
                                    ...
                                    <button
                                        className={`hover:text-foreground ${
                                            i === zoom.breadcrumbs.length - 1 ? "text-foreground font-medium" : "text-muted-foreground"
                                        }`}
                                        onClick={() => {
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                            ...
                            <div className="bg-background/90 flex items-center gap-1 rounded-md border backdrop-blur-sm">
                                <input
                                    ...
                                    className="placeholder:text-muted-foreground w-28 bg-transparent px-2 py-1.5 text-xs sm:w-40"
                                />
                                {gs.searchQuery && (
                                    <button
            ...
            {gs.selectedChunkId && isMobile && (
                <div className="bg-background shrink-0 overflow-y-auto border-t" style={{ maxHeight: "40vh" }}>
                    <GraphDetailPanel
                        chunkId={gs.selectedChunkId}
                        onClose={() => dispatch({ type: "SET_SELECTED_CHUNK", id: null })}
                        onNavigateToChunk={id => {
