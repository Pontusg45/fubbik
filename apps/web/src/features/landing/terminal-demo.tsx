...
export function TerminalDemo() {
    const [visibleLines, setVisibleLines] = useState<{ text: string; type: "command" | "output" }[]>([]);
                    ...
                    {visibleLines.map((line, i) => {
                        ...
                        return (
                            <div key={i} className="min-h-[1.625rem]">
                                <span className={line.type === "command" ? "text-foreground" : "text-emerald-400"}>{line.text}</span>
