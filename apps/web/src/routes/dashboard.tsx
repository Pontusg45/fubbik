            ...
            <div className="grid gap-6 lg:grid-cols-3">
                <div className="lg:col-span-2">
                    <div className="mb-3 flex items-center justify-between">
                        ...
                        <Button variant="link" size="sm" render={<Link to="/chunks" search={{ page: 1, type: undefined, q: undefined, sort: undefined, tags: undefined, size: undefined, after: undefined, enrichment: undefined }} />}>
                            View All
                        </Button>
                    </div>
                    <Card>
