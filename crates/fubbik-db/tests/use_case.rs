...
// ---------------------------------------------------------------------
// find_by_name (backs requirements::batch_service's auto-vivification)
// ---------------------------------------------------------------------
...
/// Proves the `user_id` scope: Bob searching for Alice's use case name by
/// exact string match must not find it.
#[sqlx::test]
