...
export const plan = pgTable(
    ...
    table => [index("plan_userId_idx").on(table.userId), index("plan_spaceId_idx").on(table.spaceId)]
);
...
export const planRequirement = pgTable(
    ...
    t => [uniqueIndex("plan_requirement_unique_idx").on(t.planId, t.requirementId), index("plan_requirement_planId_idx").on(t.planId)]
);
...
export const planAnalyzeItem = pgTable(
    ...
    table => [index("plan_analyze_item_planId_idx").on(table.planId), index("plan_analyze_item_chunkId_idx").on(table.chunkId)]
);
...
export const planTaskChunk = pgTable(
    ...
    t => [uniqueIndex("plan_task_chunk_unique_idx").on(t.taskId, t.chunkId, t.relation), index("plan_task_chunk_taskId_idx").on(t.taskId)]
);
