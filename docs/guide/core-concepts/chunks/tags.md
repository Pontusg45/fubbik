...
- Special purposes (`claude-md` to include in generated CLAUDE.md)
...
On the chunk detail page, click the tag area to add or remove tags inline. Start typing to search existing tags or create new ones.
