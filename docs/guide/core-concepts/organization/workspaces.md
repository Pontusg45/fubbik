...
A workspace groups related codebases together. For example, you might have a "Platform" workspace containing your frontend, backend, and
...
When you select a workspace in the codebase switcher, all views (chunks, graph, search) show data from all codebases in that workspace. This
is useful for:
