...
Use `related_to` as a catch-all only when no specific type fits. Prefer more specific types — they convey meaning that helps the graph view,
context export, and AI tools understand your knowledge structure.
