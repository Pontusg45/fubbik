...
- [Installation](./installation.md) — clone, install, and set up
- [Quick Start](./quick-start.md) — your first five minutes with fubbik
- [Configuration](./configuration/) — environment variables, database, and optional services
