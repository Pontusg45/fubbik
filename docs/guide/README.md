...
Complete documentation for using the fubbik knowledge framework.
...
- **Requirements** — BDD specifications, vocabulary, and traceability
...
- **Views** — kanban, browse, timeline, compare, compose, density, coverage
- **Overlays** — feature branches for knowledge modifications
- **Navigation** — keyboard shortcuts, command palette, favorites, focus mode
- **Review** — review queue, status management, archives
- **Plans** — implementation tracking and sessions
- **Templates** — standardized chunk creation
- **Health** — staleness detection, maintenance workflows
