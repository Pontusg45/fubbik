...
Features are named entities that track field-level modifications to chunks — like branches for your knowledge base. Each feature stores
deltas (sparse objects containing only changed fields) that overlay on top of the base chunks.
